...
{
    public  class SingletonBase2<TType> where TType : class
    {
        #region Members
       ...
       // private static readonly Lazy<TType> sInstance = new Lazy<TType>(() => CreateInstanceOfT());
        //private readonly Lazy<TType> sInstance = new Lazy<TType>(() => CreateInstanceOfT());
       ...
       // public  TType Current { get { return sInstance.Value; } }
        ...
        /// </summary>
        /// <returns></returns>
        private  TType CreateInstanceOfT()
        {
