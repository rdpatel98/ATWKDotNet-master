...
namespace SHABS.MODELS
{
	public class PushNotification2
	{
		...
		public void SendModelNotification(NotificaitonModel objMessage, string RegistrationId)
		{
            ...
            string[] title = new string[] { "{\"to\":\"", str, "\", \"priority\" : \"high\" ,\"notification\":{\"body\": \"", text, "\",\"title\" : \"", objMessage.Title, "\",\"content_available\": 1,\"sound\":\"default\"},\"data\":{\"Text\":\"", objMessage.Text, "\",\"SendTo\":\"", objMessage.SendTo, "\",\"SentFrom\":\"", objMessage.SentFrom, "\",\"Subject\":\"", objMessage.Subject, "\",\"ayatollah\":\"", objMessage.ayatollah, "\",\"UserType\":\"MODERATOR\",\"FromName\":\"", objMessage.FromName, "\",\"FromImageID\":\"", objMessage.FromImageID, "\",\"ToName\":\"", objMessage.ToName, "\",\"ToImageID\":\"", objMessage.ToImageID, "\",\"Title\":\"", objMessage.Title, "\",\"ContentType\":\"", objMessage.ContentType, "\"}}" };
        ...
        public void SendFCMNotification(NotificaitonModel objMessage)
        {
            ...
            objMessage.Title = "Message from Ask Those Who Know";
            string text = objMessage.Text;
